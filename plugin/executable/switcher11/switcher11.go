...
func (m *switchMatcher11) Match(_ context.Context, _ *query_context.Context) (bool, error) {
	if globalSwitcher11 == nil {
		return false, nil
	}
	globalSwitcher11.mutex.RLock()
	defer globalSwitcher11.mutex.RUnlock()
	return globalSwitcher11.value == m.expected, nil
}

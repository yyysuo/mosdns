...
func (m *switchMatcher13) Match(_ context.Context, _ *query_context.Context) (bool, error) {
	if globalSwitcher13 == nil {
		return false, nil
	}
	globalSwitcher13.mutex.RLock()
	defer globalSwitcher13.mutex.RUnlock()
	return globalSwitcher13.value == m.expected, nil
}

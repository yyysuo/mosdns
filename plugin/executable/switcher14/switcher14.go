...
func (m *switchMatcher14) Match(_ context.Context, _ *query_context.Context) (bool, error) {
	if globalSwitcher14 == nil {
		return false, nil
	}
	globalSwitcher14.mutex.RLock()
	defer globalSwitcher14.mutex.RUnlock()
	return globalSwitcher14.value == m.expected, nil
}
